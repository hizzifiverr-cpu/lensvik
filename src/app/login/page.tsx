                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="bg-white border border-slate-200 rounded-3xl p-8 shadow-xl shadow-slate-100/50">
                        <div className="text-center mb-8">
                            <h1 className="text-2xl font-black tracking-tighter mb-2">Welcome Back</h1>
                            <p className="text-sm text-slate-500 font-medium">Sign in to your Lensvik account</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full bg-slate-900 text-white text-sm font-bold py-4 rounded-xl hover:bg-black transition-all shadow-lg disabled:opacity-50 uppercase tracking-tight"
                            >
